...
import {doHpke} from './hooks/try';
import { burnTrade } from './hooks/burner';
    ...
    <main style={{ padding: 40 }}>
      ...
      >
       ...
       {/* <button
        ...
        style={{ backgroundColor: '#FF007A', color: 'white', padding: '8px 16px', border: 'none', borderRadius: 4 }}
      >
        Send Privately other way
      </button> */}

      <button
        onClick={burnerTest}
        style={{ backgroundColor: '#FF007A', color: 'white', padding: '8px 16px', border: 'none', borderRadius: 4, marginLeft: 10 }}
      >
        Burn Trade
      </button>
    </main>
